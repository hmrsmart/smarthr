        ...
        <div className="page-header">
          <div className="row">
            <div className="col-sm-12">
              <h3 className="page-title">حضور الموظف</h3>
        ...
        <div className="row">
            ...
            <div className="card punch-status">
              <div className="card-body">
                <h5 className="card-title">
                  جدول التوقيتات{" "}
                  <small className="text-muted">11 Mar 2022</small>
                </h5>
                <div className="punch-det">
                  <h6>Punch In at</h6>
                  <p>Wed, 11th Mar 2022 10.00 AM</p>
                </div>
          ...
          <div className="col-md-4">
            <div className="card recent-activity">
              <div className="card-body">
                <h5 className="card-title">انشطة اليوم</h5>
